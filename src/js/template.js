...
export function template({
  ...
  const article = `
    <article id="comment-${id}" class="bg-white relative rounded-md ${
    isReply ? "w-19/20 mt-2" : "w-full mb-2 mt-2"
  } p-3 grid grid-cols-2 md:grid-cols-[auto_1fr_auto] gap-6 items-start"
      >
      <div class="col-start-1 row-start-2 w-fit py-4 px-2 bg-grey-50 rounded-lg flex flex-row gap-3 items-center md:row-start-1 md:col-start-1 md:flex-col">
